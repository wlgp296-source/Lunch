...
export function renderTeamLobby(state) {
  ...
  return shell(`
    <section class="page-content team-flow-content">
      ...
      <button class="secondary-button action-button member-condition-button" data-action="member-preferences"><span>${icon('person')}<b>내 조건 입력하기</b></span>${icon('arrow')}</button>
